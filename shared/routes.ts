    ...
    projectAlerts: {
      ...
      update: {
        ...
        input: z.object({
          ...
          cpuAlertEnabled: z.boolean().optional(),
          memoryAlertEnabled: z.boolean().optional(),
          storageAlertEnabled: z.boolean().optional(),
          dbStorageAlertEnabled: z.boolean().optional(),
          dbConnectionAlertEnabled: z.boolean().optional(),
          clusterCpuAlertEnabled: z.boolean().optional(),
          clusterMemoryAlertEnabled: z.boolean().optional(),
          webResponseAlertEnabled: z.boolean().optional(),
          webStatusAlertEnabled: z.boolean().optional(),
          webSslAlertEnabled: z.boolean().optional(),
          domainExpiryAlertEnabled: z.boolean().optional(),
        }),
        responses: {
          200: z.custom<any>(),
          404: errorSchemas.notFound,
